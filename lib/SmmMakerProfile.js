...
class _SmmMakerProfile {
    ...
    /**
     * @method module:_SmmMakerProfile::getWebContent
     * Do request and capture callbackFunction from user app
     * @arg {String} nintendoId Nintendo ID of user
     * @arg {Callback} callbackFunction callback of user
     * @access public
     * @returns {Callback}
     */
    getWebContent(nintendoId, callbackFunction) {
        let $this = this;
...
var ssmMakerProfile = new _SmmMakerProfile();
module.exports = ssmMakerProfile;